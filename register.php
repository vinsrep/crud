            ...
            <div class="d-flex justify-content-center">
                <div class="card mb-3" style="max-width: 40rem;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="cover-image.png" class="card-img rounded-right" alt="Image Cover">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <br>
                                ...
                                <p class="mb-5 text-muted">Please fill this form to create an account!</p>
                                    ...
                                    <div class="input-group">   
                                        <div class="mb-5">
                                            <label class="form-check-label" for="exampleCheck1"><a class="link-primary" href="forgot.php">Forgot Password?</a></label>
                                        </div>
                                    </div>
